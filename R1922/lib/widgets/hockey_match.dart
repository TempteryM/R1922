...
class HockeyMatch extends StatefulWidget {
  const HockeyMatch({Key? key}) : super(key: key);

  @override
  State<HockeyMatch> createState() => HockeyMatchState();
}

class HockeyMatchState extends State<HockeyMatch> {
  Future<List<Match>> footballFuture = getHockey();

  static Future<List<Match>> getHockey() async {
    const url = 'http://kbvolna.com/matchapp/matchHockey.json';
